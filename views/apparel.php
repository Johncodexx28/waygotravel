<?php 
   session_start();
   $pageTitle = "Apparel - WayGo Travel";
   ...
   WHERE categories.category_name = 'Apparel'
...
<html lang="en">
   ...
   <body>
      ...
      <main class="main">
         ...
         <section id="hero" class="hero section " style="background-position: center; background-image:url(../assets/img/bannerapparel.png)" >
            <div class="container">
            </div>
         </section>
