                  ...
                  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mb-4">
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           ...
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access1.webp" alt="Herschel Backpack Black" class="img-fluid">
                           </div>
                           ...
                           <div class="p-3">
                              <h5 class="product-title">Chapter Travel Kit | Small -3L</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱2,061.00</div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           ...
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access2.webp"alt="Herschel Backpack Black Tan" class="img-fluid">
                           </div>
                           <div class="color-options text-center mb-2">
                           ...
                           <div class="p-3">
                              <h5 class="product-title">Charle Cardholder Wallet</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱1,611.00</div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           <div class="sale-badge">10% off</div>
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access3.webp" alt="Herschel Backpack Gray" class="img-fluid">
                           </div>
                           <div class="color-options text-center mb-2">
                              <span class="color-option" style="background-color: #000000;"></span>
                              <span class="color-option" style="background-color: #696969;"></span>
                           ...
                           <div class="p-3">
                              <h5 class="product-title">Luggage Tag | Vegan Leather</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱1,161.00</div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           <div class="sale-badge">10% off</div>
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access4.webp"alt="Herschel Backpack Pink" class="img-fluid">
                           </div>
                           <div class="color-options text-center mb-2">
                              <span class="color-option" style="background-color: #8B4513;"></span>
                              <span class="color-option" style="background-color: #FF1493;"></span>
                           ...
                           <div class="p-3">
                              <h5 class="product-title">Luggage Belt</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱1,161,00</div>
                                 <div class="sale-price">Sale</div>
                              </div>
                  ...
                  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           <div class="sale-badge">10% off</div>
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access5.webp" alt="Herschel Backpack Black" class="img-fluid">
                           </div>
                           <div class="p-3">
                              <h5 class="product-title">Norman Stonewash Bucket Hat Head Gear</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱2,232.00</div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           ...
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access6.webp" alt="Herschel Backpack Black Leather" class="img-fluid">
                           </div>
                           <div class="p-3">
                              <h5 class="product-title">Denman Sleeve | Tech - 14 Inch</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱3,411.00 </div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           <div class="sale-badge">10% off</div>
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access7.webp" alt="Herschel Urban Backpack" class="img-fluid">
                           </div>
                           <div class="p-3">
                              <h5 class="product-title">Pop Quiz Cooler 12 Pack | Insulated</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱4,193.00 </div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col">
                        <div class="product-card position-relative">
                           <div class="sale-badge">10% off</div>
                           <div class="text-center p-3">
                              <img src="../assets/img/accessories/access8.webp" alt="Herschel Backpack Pink" class="img-fluid">
                           </div>
                           <div class="p-3">
                              <h5 class="product-title">Milan Toiletry Bag | Vegan Leather</h5>
                              <div class="d-flex">
                                 <div class="product-price">₱2,770.00 </div>
                                 <div class="sale-price">Sale</div>
                              </div>
                           </div>
                        </div>
